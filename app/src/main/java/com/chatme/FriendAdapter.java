...
public class FriendAdapter extends RecyclerView.Adapter<FriendAdapter.FriendHolder> {
    ...
    public void onBindViewHolder(@NonNull FriendHolder holder, int position) {
        ...
        Picasso.get().load("https://chatmenow.000webhostapp.com/chatme/img/"+Picture.get(position)).into(holder.FriendImg);
    ...
    public void send_request(final String id){
        ...
        String url = "https://chatmenow.000webhostapp.com/chatme/send_request.php";
